...
if Structure == 'Slab':
    ...
    unitlength = 50
    density_list1 = [0.004]
    density_list2 = [0.004,0.008,0.012] # This is a compartment closer to the orgin of substances
    cellPerdead = 10
...
############################################
    ...
    density_list1 = [0.00025,0.0005,0.001] # maximum 0.001 with current dimension in square/round geometry : This is inner ring
    density_list2 = [0.0005]
    cellPerdead = 10
    DiffState = 'error'
